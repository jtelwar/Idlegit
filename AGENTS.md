...
6. Maintain log of recent work in [text](VERSION) upon completing a task. Add a sub-heading for each version number if it doesn't exist, then one-line entry with CURRENT date in short form - and short description of assigned task that has been completed.
